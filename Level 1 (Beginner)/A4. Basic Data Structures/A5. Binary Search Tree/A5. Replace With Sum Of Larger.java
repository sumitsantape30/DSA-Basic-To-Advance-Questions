...
public class Main {
  ...
  public static void rwsol(Node node){
    ...
    //1. pehle reverse inorder likhdenge
    rwsol(node.right);
    
    //2. yeh reverse inorder ka area hai
    int d= node.data; //pehle node.data ko preserve karwa lenge
    node.data= sum; //ab node.data ko replace kardo sum se
    sum += d; //aur sum mai jo node.data ki value this usko add kardo
