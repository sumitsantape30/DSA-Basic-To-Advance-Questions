...
public class DecimaltoanyBase {
	...
	public static int getValueInitialised( int n, int b) {
		...
		while( n > 0) {
			int rem= n % b;  //jis base mai convert karna hai usase divide karenge, so sabse pehle uski last digit nikal lo
			n= n/b; //number ko chota kardenge
			
			//so jo pehle digit se jo pehla remainder(last digit) aya hai usko sabse right mai bhejna hai to uske 10 ki sabse choti power se mutlipy karenge
