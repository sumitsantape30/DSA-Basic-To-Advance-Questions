...
public class Main {
  ...
  static int tilt = 0; //hume iss tild data memebr ko value set karni hai using this tilt function
  public static int sum(Node node){ //yeh function return kuch aur karega aur kam kuch aur karega (function ka nam tilt tha maine sum kardiya)
  // yeh sum return karega aur iski help se mai tilt data memeber ki value update karaunga
    if( node == null){
        return 0;
    }
