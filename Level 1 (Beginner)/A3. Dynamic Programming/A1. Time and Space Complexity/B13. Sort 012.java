...
public class Sort012 {
	...
	public static void sort012(int[] arr) {
		...
		while( i <= k) { //jab i k ko cross karega (means jab k ke bad i ayega) tabhi unknowns khatam honge. End mai ho skta hai ki i and k dono bhi 0 pe hai but 0 to compare hi nhi hua na so rukenge nhi chalte rahenge till i<=k
