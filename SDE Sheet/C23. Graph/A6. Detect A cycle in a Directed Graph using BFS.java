...
//         }
         ...
         if(topo.length == N) return false; //if topo sort is produced means it doesnt have cycle so return false
         return true; //otherwise it does have a cycle
         //upar topo array rakhne ki jarurat bhi nhi hai you can just keep count 
     }
